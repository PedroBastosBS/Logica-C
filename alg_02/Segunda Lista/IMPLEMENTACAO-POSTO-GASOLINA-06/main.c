...
//-----------------------------------// solicita o tipo de combust�vel desejado--------------------------------
...
float cupom(float q, float r, float w){
	...
	printf("\n--------------------------------------------------\n");			
	printf("\nValor unitario R$:_____________________________%.2f", q);			
	printf("\nLitros abastecidos:___________________________ %.2f", x);
	printf("\nImposto:_______________________________________%.2f%", e);
	printf("\nValor pago R$:________________________________ %.2f", r);
	printf("\nTotal R$:______________________________________%.2f", t);
	printf("\nTroco R$:______________________________________%.2f", tr);
	printf("\n\n--------------------------------------------------\n");
	//fluxo_caixa(z, x, r, m;
